...
namespace Model
{
  ...
  /**
   */
  class AWS_TRANSCRIBESTREAMINGSERVICE_API StartStreamTranscriptionRequest : public StreamingTranscribeStreamingServiceRequest
  {
  public:
    ...
    aws_array_list GetEventStreamHeaders() const override;

    bool IsEventStreamed() const override { return true; }
