  ...
  class AWS_TRANSCRIBESTREAMINGSERVICE_API TranscribeStreamingServiceClient : public Aws::Client::AWSJsonClient
  {
    public:
      typedef Aws::Client::AWSJsonClient BASECLASS;
        ...
        */
         ...
         * API Reference</a></p>
         */
        virtual Model::StartStreamTranscriptionOutcome StartStreamTranscription(Model::StartStreamTranscriptionRequest& request) const;
         ...
         */
        virtual Model::StartStreamTranscriptionOutcomeCallable StartStreamTranscriptionCallable(Model::StartStreamTranscriptionRequest& request) const;
         ...
         */
        virtual void StartStreamTranscriptionAsync(Model::StartStreamTranscriptionRequest& request, const StartStreamTranscriptionResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const;
    ...
    private:
      void init(const Aws::Client::ClientConfiguration& clientConfiguration);
        /**Async helpers**/
        void StartStreamTranscriptionAsyncHelper(Model::StartStreamTranscriptionRequest& request, const StartStreamTranscriptionResponseReceivedHandler& handler, const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context) const;
